...
from keras_frcnn import roi_ as roi_helpers
...
rpn_layers = rpn.rpn(shared_layers, num_anchors)
from keras_frcnn import classifier
classifier = classifier.classifier(feature_map_input, roi_input, C.num_rois, nb_classes=len(class_mapping))
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	R = roi_helpers.rpn_to_roi(Y1, Y2, C, K.common.image_dim_ordering(), overlap_thresh=0.3)
	print(R.shape)
